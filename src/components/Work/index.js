    ...
    <>
      ...
      <div className="flex justify-center">
        <div className="container max-w-screen-xl grid md:grid-cols-2 relative bottom-10 justify-center mx-6 gap-12">
          ...
          <div className="h-150 flex flex-col bg-blue-200 z-10 p-10 cursor-pointer transform transition duration-500 hover:scale-110 rounded-lg shadow-lg overflow-hidden">
            <p className="text-text-primary">BookingScape</p>
            <h3 className="text-3xl font-bold text-text-dark mb-3">
              Room management platform
            </h3>
            <a className="text-center bg-blue-500 w-24 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" href="https://github.com/alexbota/bookingscape-api" target="_blank">
              Check
            </a>
          ...
          <div className="h-150 flex flex-col bg-purple-500 z-10 p-10 cursor-pointer transform transition duration-500 hover:scale-110 rounded-lg shadow-lg overflow-hidden">
            ...
            <a className="text-center bg-blue-500 w-24 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" href="https://github.com/alexbota/stonks" target="_blank">
              Check
            </a>
            <div className="w-150 my-10">
          ...
          <div className="h-150 flex flex-col bg-gray-400 z-10 p-10 cursor-pointer transform transition duration-500 hover:scale-110 rounded-lg shadow-lg overflow-hidden">
            ...
            <a className="text-center bg-gray-200 w-24 text-white font-bold py-2 px-4 rounded-full">
              Soon
            </a>
